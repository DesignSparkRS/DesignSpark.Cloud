...
# Mock modules
sys.modules['snappy'] = mock.Mock()
sys.modules['prometheus_api_client'] = mock.Mock()
sys.modules['google.protobuf'] = mock.MagicMock()

# -- Project information -----------------------------------------------------

project = 'DesignSpark.Cloud'
